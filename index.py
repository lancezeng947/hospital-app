...
def pin():
	...
	result = db.engine.execute("SELECT CONCAT(first_name, ' ', last_name) AS name, phone_number FROM patients \
		WHERE CONCAT(first_name, ' ', last_name) = %s AND phone_number = %s", (user_name, phone_number))
